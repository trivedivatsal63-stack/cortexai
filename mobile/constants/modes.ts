export const MODES = [
  {
    ...
    label: 'General',
    icon: '💬',
    systemPrompt: `You are SENTINEL, a smart AI assistant for students. 
Answer clearly and helpfully. Structure answers with sections when useful.`,
  },
  {
    ...
    label: 'Cybersecurity',
    icon: '🔐',
    systemPrompt: `You are SENTINEL, a cybersecurity expert for students. 
...
**Related Topics:** (list)`,
  },
  {
    ...
    label: 'Programming',
    icon: '💻',
    systemPrompt: `You are SENTINEL, a programming tutor for CS students.
...
Cover: concept, syntax, example code, common mistakes, best practices.`,
  },
  {
    ...
    label: 'Exam Mode',
    icon: '📋',
    systemPrompt: `You are SENTINEL in Exam Mode. 
...
Be concise. No fluff.`,
  },
  {
    ...
    label: 'Notes',
    icon: '📝',
    systemPrompt: `You are SENTINEL in Notes Mode.
